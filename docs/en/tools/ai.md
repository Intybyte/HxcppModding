...
Q: Did you ever write a parse number functions from a string?

A: Probably not, most high level progamming languages already have a good implementation.

-----

Q: Did you ever make an array grow function?

A: Possible if you have written some C code, but unlikely for most people, all languages that have a list backed by an array probably already wrote that a lot of times.

---

Q: Did you ever make a good list sort function, maybe like quick sort?

A: I know bubble sort!
